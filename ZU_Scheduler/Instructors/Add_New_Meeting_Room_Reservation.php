...
$insert = mysqli_query($dbConn,"insert into meeting_rooms_reservations (Room_ID,Instructor_ID,Date,Time_From,Time_To) values ('$MR_ID','$I_ID','$Date','$Time_From','$Time_To')");
