...
<li><a href="View_Mid_Schedules_List.php">View Mid Schedules List</a></li>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>View Meeting Room Reservations List Information | <a href="Add_New_Meeting_Room_Reservation.php?MR_ID=<?php echo $MR_ID; ?>" class="btn btn-primary">Add New Meeting Room Reservation</a></h5>
                    ...
                    <tbody>
                    <?php
					$sql1 = mysqli_query($dbConn,"select * from meeting_rooms_reservations where Room_ID='$MR_ID' order by ID DESC");
					...
					$sql2 = mysqli_query($dbConn,"select * from instructors where ID='$Instructor_ID'");
					$row2 = mysqli_fetch_array($sql2);
					$Instructor_Name = $row2['Instructor_Name'];
 ...
 <a href="JavaScript:if(confirm('Are You Sure To Delete This Meeting Room Reservation ?')==true)
{location.replace('Delete_Meeting_Room_Reservation.php?MRR_ID=<?php echo $MRR_ID; ?>&MR_ID=<?php echo $MR_ID; ?>')}" class="btn btn-primary btn-sm" role="button">Delete</a>
