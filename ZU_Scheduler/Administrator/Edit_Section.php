...
$sql1 = mysqli_query($dbConn,"select * from sections where ID='$S_ID'");
$row1 = mysqli_fetch_array($sql1);


$Section_Number = $row1['Section_Number'];
...
$sql1 = mysqli_query($dbConn,"update sections set Department='$Department', Section_Number='$Section_Number', Semester='$Semester', Year='$Year', Total_Students_Capacity='$Total_Students_Capacity' where ID='$S_ID'");

echo "<script language='JavaScript'>
			  alert ('Section Information Has Been Updated !');
      </script>";
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                     ...
                     <form method="post" action="Edit_Section.php?S_ID=<?php echo $S_ID; ?>&C_ID=<?php echo $C_ID; ?>" class="form-horizontal" enctype="multipart/form-data">
