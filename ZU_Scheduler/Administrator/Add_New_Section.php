...
$sql11 = mysqli_query($dbConn,"select * from sections where Course_ID='$C_ID' order by Section_Number DESC");
if (mysqli_num_rows($sql11)>0){
	
	$row11 = mysqli_fetch_array($sql11);
	
	$Section_Number = $row11['Section_Number'] + 1;
...
$Section_Name = mysqli_real_escape_string($dbConn,$_POST['Section_Name']);
$Total_Students_Capacity = mysqli_real_escape_string($dbConn,$_POST['Total_Students_Capacity']);

$Section_Number = mysqli_real_escape_string($dbConn,$_POST['Section_Number']);

$Year1 = mysqli_real_escape_string($dbConn,$_POST['Year']);
$Semester1 = mysqli_real_escape_string($dbConn,$_POST['Semester']);
...
$insert = mysqli_query($dbConn,"insert into sections (Department,Section_Number,Year,Semester,Course_ID,Instructor_ID,Total_Students_Capacity) values 
('$Department','$Section_Number','$Year1','$Semester1','$C_ID','$Instructor_ID','$Total_Students_Capacity')");
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Section <?php echo $Section_Number;?>    <?php echo $Course_Name; ?></h5>
                     ...
                     <form method="post" action="Add_New_Section.php?C_ID=<?php echo $C_ID; ?>" class="form-horizontal" enctype="multipart/form-data">
...
?>  				
                                ...
                                <div class="hr-line-dashed"></div>
								 ...
								 <div class="form-group"><label class="col-sm-2 control-label">Section Number *</label>

                                    <div class="col-sm-10"><input readonly value="<?php echo $Section_Number; ?>" style="width:40%" type="text" name="Section_Number" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
 ...
 <div class="form-group"><label class="col-sm-2 control-label">Total Students Capacity *</label>
                                    ...
                                    <div class="col-sm-10"><input value="" style="width:40%" type="number" min="1" name="Total_Students_Capacity" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
