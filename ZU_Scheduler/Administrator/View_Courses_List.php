            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>View Courses List Information</h5>
                    ...
                    <tr>
                            ...
                            <th>Course Number</th>
                            <th>Course Name</th>
                            <th>Mid Hours (In Minutes)</th>
                            <th>Final Hours (In Minutes)</th>
                    ...
                    <tbody>
                    <?php
					$sql1 = mysqli_query($dbConn,"select * from courses where Department='$Department' AND Year='$Year' AND Semester='$Semester' order by ID DESC");
                    ...
                    <tr class="grade">
                          ...
                          <td><?php echo $Mid_Hours; ?></td>
                          <td><?php echo $Final_Hours; ?></td>
                          
                      
                     
 <td><center>
 
 <a href="Manage_Sections.php?Department=<?php echo $Department; ?>&Semester=<?php echo $Semester; ?>&Year=<?php echo $Year; ?>&Course_Name=<?php echo $Course_Name; ?>&C_ID=<?php echo $C_ID; ?>"  class="btn btn-primary btn-sm" role="button">Manage Sections</a>

 
<a href="Edit_Course.php?C_ID=<?php echo $C_ID; ?>" style="width:52px" class="btn btn-primary btn-sm" role="button">Edit</a> 

 <a href="JavaScript:if(confirm('Are You Sure To Delete This Course ?')==true)
{location.replace('Delete_Course.php?C_ID=<?php echo $C_ID; ?>')}" class="btn btn-primary btn-sm" role="button">Delete</a>
