...
$sql1 = mysqli_query($dbConn,"select * from rooms where Room_Name='$Room_Name'");
...
$insert = mysqli_query($dbConn,"insert into rooms (Department,Year,Semester,Room_Name,Room_Type,Total_Students_Capacity) values ('$Department','$Year','$Semester','$Room_Name','$Room_Type','$Total_Students_Capacity')");
...
echo "<script language='JavaScript'>
			  alert ('New Room Has Been Added Successfully !');
      </script>";
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                     ...
                     <form method="post" action="Add_New_Room.php" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="hr-line-dashed"></div>
								 ...
								 <div class="form-group"><label class="col-sm-2 control-label">Room Name *</label>
                                    ...
                                    <div class="col-sm-10"><input value="" style="width:40%" type="text" name="Room_Name" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
