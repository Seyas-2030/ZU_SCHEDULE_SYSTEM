...
<li><a href="View_Mid_Schedules_List.php">View Mid Schedules List</a></li>
 ...
 <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>View Final No Rooms Sections List Information </h5>
					...
					$sql1 = mysqli_query($dbConn,"select * from sections where Year='$Year' AND Semester='$Semester' AND Department='$Department' order by ID DESC");
					while ($row1 = mysqli_fetch_array($sql1)){
						...
						$Section_Total_Students_Capacity = $row1['Total_Students_Capacity'];
	...
	$sql7 = mysqli_query($dbConn,"select * from courses where ID='$Course_ID'");
...
$sql8 = mysqli_query($dbConn,"select * from final_schedules where Section_ID='$S_ID'");
