...
<li><a href="View_Mid_Schedules_List.php">View Mid Schedules List</a></li>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>View Meeting Rooms List Information</h5>
                    ...
                    <tbody>
                    <?php
					$sql1 = mysqli_query($dbConn,"select * from meeting_rooms where Department='$Department' AND Year='$Year' AND Semester='$Semester' order by ID DESC");
 ...
 <a href="Manage_Meeting_Room_Reservations.php?MR_ID=<?php echo $MR_ID; ?>" class="btn btn-primary btn-sm" role="button">Manage Meeting Room Reservations</a>


 <a href="Edit_Meeting_Room.php?MR_ID=<?php echo $MR_ID; ?>" style="width:52px" class="btn btn-primary btn-sm" role="button">Edit</a>

 <a href="JavaScript:if(confirm('Are You Sure To Delete This Meeting Room ?')==true)
{location.replace('Delete_Meeting_Room.php?MR_ID=<?php echo $MR_ID; ?>')}" class="btn btn-primary btn-sm" role="button">Delete</a>
