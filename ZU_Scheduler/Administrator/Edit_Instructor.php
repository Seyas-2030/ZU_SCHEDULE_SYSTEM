...
$sql1 = mysqli_query($dbConn,"select * from instructors where ID='$I_ID'");
$row1 = mysqli_fetch_array($sql1);


$Instructor_Name = $row1['Instructor_Name'];
$Instructor_Username = $row1['Instructor_Username'];
$Instructor_Password = $row1['Instructor_Password'];
...
{
$I_ID = mysqli_real_escape_string($dbConn,$_POST['I_ID']);



$Instructor_Name = mysqli_real_escape_string($dbConn,$_POST['Instructor_Name']);
$Instructor_Username = mysqli_real_escape_string($dbConn,$_POST['Instructor_Username']);
$Instructor_Password = mysqli_real_escape_string($dbConn,$_POST['Instructor_Password']);
...
$sql1 = mysqli_query($dbConn,"select * from instructors where Instructor_Name='$Instructor_Name' AND ID!='$I_ID'");
$sql2 = mysqli_query($dbConn,"select * from instructors where Instructor_Username='$Instructor_Username' AND ID!='$I_ID'");
if (mysqli_num_rows($sql1)>0){
	
	   echo "<script language='JavaScript'>
			  alert ('Sorry ! This Instructor Name Already Exist !');
      </script>";
	   ...
	   echo "<script language='JavaScript'>
			  alert ('Sorry ! This Instructor Username Already Exist !');
      </script>";
	  
}else{
 

$sql1 = mysqli_query($dbConn,"update instructors set Instructor_Password='$Instructor_Password', Instructor_Username='$Instructor_Username', Department='$Department', Year='$Year', Semester='$Semester', Instructor_Name='$Instructor_Name' where ID='$I_ID'");

echo "<script language='JavaScript'>
			  alert ('Instructor Information Has Been Updated !');
      </script>";
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Edit Instructor Information</h5>
                     ...
                     <form method="post" action="Edit_Instructor.php?I_ID=<?php echo $I_ID; ?>" class="form-horizontal" enctype="multipart/form-data">
							  ...
							  <div class="form-group"><label class="col-sm-2 control-label">Year *</label>
                                ...
                                <div class="hr-line-dashed"></div>
								 ...
								 <div class="form-group"><label class="col-sm-2 control-label">Instructor Name *</label>
                                    ...
                                    <div class="col-sm-10"><input type="text" style="width:40%" name="Instructor_Name" value="<?php echo $Instructor_Name; ?>" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
								 ...
								 <div class="form-group"><label class="col-sm-2 control-label">Instructor Username *</label>

                                    <div class="col-sm-10"><input type="text" style="width:40%" name="Instructor_Username" value="<?php echo $Instructor_Username; ?>" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
								 ...
								 <div class="form-group"><label class="col-sm-2 control-label">Instructor Password *</label>

                                    <div class="col-sm-10"><input type="password" style="width:40%" name="Instructor_Password" value="<?php echo $Instructor_Password; ?>" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
