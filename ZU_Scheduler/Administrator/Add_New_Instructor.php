...
$sql1 = mysqli_query($dbConn,"select * from instructors where Instructor_Name='$Instructor_Name'");
...
$insert = mysqli_query($dbConn,"insert into instructors (Instructor_Username,Instructor_Password,Department,Year,Semester,Instructor_Name) values ('$Instructor_Username','$Instructor_Password','$Department','$Year','$Semester','$Instructor_Name')");
...
echo "<script language='JavaScript'>
			  alert ('New Instructor Has Been Added Successfully !');
      </script>";
...
<li><a href="View_Mid_Schedules_List.php">View Mid Schedules List</a></li>
 ...
 <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                     ...
                     <form method="post" action="Add_New_Instructor.php" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="hr-line-dashed"></div>
								 ...
								 <div class="form-group"><label class="col-sm-2 control-label">Instructor Name *</label>
                                    ...
                                    <div class="col-sm-10"><input value="" style="width:40%" type="text" name="Instructor_Name" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
							 ...
							 <div class="form-group"><label class="col-sm-2 control-label">Instructor Username *</label>
                                    ...
                                    <div class="col-sm-10"><input value="" style="width:40%" type="text" name="Instructor_Username" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
	 ...
	 <div class="form-group"><label class="col-sm-2 control-label">Instructor Password *</label>
                                    ...
                                    <div class="col-sm-10"><input value="" style="width:40%" type="password" name="Instructor_Password" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
