            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>View Mid Schedules List Information | <a href="Generate_Mid_Schedules.php" class="btn btn-primary">Generate Mid Schedules</a> | <a href="Clear_Mid_Schedules.php" class="btn btn-primary">Clear Mid Schedules</a> | <a href="View_Mid_No_Sections_Rooms.php" class="btn btn-primary">View Mid No Sections Rooms</a>
                    ...
                    <tbody>
                    <?php
					$sql1 = mysqli_query($dbConn,"select * from mid_schedules where Department='$Department' AND Year='$Year' AND Semester='$Semester' order by ID DESC");
