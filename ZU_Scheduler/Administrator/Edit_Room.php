...
$sql1 = mysqli_query($dbConn,"select * from rooms where ID='$R_ID'");
$row1 = mysqli_fetch_array($sql1);


$Room_Name = $row1['Room_Name'];
$Room_Type = $row1['Room_Type'];
$Total_Students_Capacity = $row1['Total_Students_Capacity'];
...
$Room_Name = mysqli_real_escape_string($dbConn,$_POST['Room_Name']);
$Room_Type = mysqli_real_escape_string($dbConn,$_POST['Room_Type']);
$Total_Students_Capacity = mysqli_real_escape_string($dbConn,$_POST['Total_Students_Capacity']);
...
$sql1 = mysqli_query($dbConn,"select * from rooms where Room_Name='$Room_Name' AND ID!='$R_ID'");
if (mysqli_num_rows($sql1)>0){
	
	   echo "<script language='JavaScript'>
			  alert ('Sorry ! This Room Name Already Exist !');
      </script>";
...
$sql1 = mysqli_query($dbConn,"update rooms set Department='$Department', Semester='$Semester', Year='$Year', Total_Students_Capacity='$Total_Students_Capacity', Room_Type='$Room_Type', Room_Name='$Room_Name' where ID='$R_ID'");

echo "<script language='JavaScript'>
			  alert ('Room Information Has Been Updated !');
      </script>";
...
<li><a href="View_Mid_Schedules_List.php">View Mid Schedules List</a></li>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                     ...
                     <form method="post" action="Edit_Room.php?R_ID=<?php echo $R_ID; ?>" class="form-horizontal" enctype="multipart/form-data">
							...
							<div class="form-group"><label class="col-sm-2 control-label">Department *</label>
							 ...
							 <div class="form-group"><label class="col-sm-2 control-label">Year *</label>
                                ...
                                <div class="hr-line-dashed"></div>
									 ...
									 <div class="form-group"><label class="col-sm-2 control-label">Room Name *</label>

                                    <div class="col-sm-10"><input value="<?php echo $Room_Name; ?>" style="width:40%" type="text" name="Room_Name" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
 ...
 <div class="form-group"><label class="col-sm-2 control-label">Room Type *</label>

                                    <div class="col-sm-10">
									
									
									
<select name="Room_Type" style="width:40%" class="form-control required" title="Room Type" required>';
 ...
 <div class="form-group"><label class="col-sm-2 control-label">Total Students Capacity *</label>

                                    <div class="col-sm-10"><input value="<?php echo $Total_Students_Capacity; ?>" style="width:40%" type="number" min="1" name="Total_Students_Capacity" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
