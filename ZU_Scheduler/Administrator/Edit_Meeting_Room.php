...
$sql1 = mysqli_query($dbConn,"select * from meeting_rooms where ID='$MR_ID'");
...
$sql1 = mysqli_query($dbConn,"select * from meeting_rooms where Room_Name='$Room_Name' AND ID!='$MR_ID'");
if (mysqli_num_rows($sql1)>0){
	
	   echo "<script language='JavaScript'>
			  alert ('Sorry ! This Meeting Room Name Already Exist !');
      </script>";
...
$sql1 = mysqli_query($dbConn,"update meeting_rooms set Department='$Department', Semester='$Semester', Year='$Year', Room_Name='$Room_Name' where ID='$MR_ID'");

echo "<script language='JavaScript'>
			  alert ('Meeting Room Information Has Been Updated !');
      </script>";
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Edit Meeting Room Information</h5>
                     ...
                     <form method="post" action="Edit_Meeting_Room.php?MR_ID=<?php echo $MR_ID; ?>" class="form-horizontal" enctype="multipart/form-data">
