...
$sql1 = mysqli_query($dbConn,"select * from courses where (Course_Name='$Course_Name' OR Course_Number='$Course_Number') AND Department='$Department'");
...
$insert = mysqli_query($dbConn,"insert into courses (Mid_Hours,Final_Hours,Department,Year,Semester,Course_Number,Course_Name) values ('$Mid_Hours','$Final_Hours','$Department','$Year','$Semester','$Course_Number','$Course_Name')");
...
<li><a href="View_Mid_Schedules_List.php">View Mid Schedules List</a></li>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                     ...
                     <form method="post" action="Add_New_Course.php" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="hr-line-dashed"></div>
								 ...
								 <div class="form-group"><label class="col-sm-2 control-label">Course Number *</label>
                                    ...
                                    <div class="col-sm-10"><input value="" style="width:40%" type="text" name="Course_Number" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
 ...
 <div class="form-group"><label class="col-sm-2 control-label">Course Name *</label>
                                    ...
                                    <div class="col-sm-10"><input value="" style="width:40%" type="text" name="Course_Name" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
 ...
 <div class="form-group"><label class="col-sm-2 control-label">Mid Hours (In Minutes) *</label>
                                    ...
                                    <div class="col-sm-10"><input value="" style="width:40%" type="text" name="Mid_Hours" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
 ...
 <div class="form-group"><label class="col-sm-2 control-label">Final Hours (In Minutes) *</label>
                                    ...
                                    <div class="col-sm-10"><input value="" style="width:40%" type="text" name="Final_Hours" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
