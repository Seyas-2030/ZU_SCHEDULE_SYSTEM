...
$sql1 = mysqli_query($dbConn,"select * from courses where ID='$C_ID'");
$row1 = mysqli_fetch_array($sql1);


$Course_Number = $row1['Course_Number'];
$Course_Name = $row1['Course_Name'];
$Mid_Hours = $row1['Mid_Hours'];
$Final_Hours = $row1['Final_Hours'];
...
$Course_Number = mysqli_real_escape_string($dbConn,$_POST['Course_Number']);
$Course_Name = mysqli_real_escape_string($dbConn,$_POST['Course_Name']);
$Mid_Hours = mysqli_real_escape_string($dbConn,$_POST['Mid_Hours']);
$Final_Hours = mysqli_real_escape_string($dbConn,$_POST['Final_Hours']);
...
$sql1 = mysqli_query($dbConn,"select * from courses where (Course_Name='$Course_Name' OR Course_Number='$Course_Number') AND Department='$Department' AND ID!='$C_ID'");
if (mysqli_num_rows($sql1)>0){
	
	   echo "<script language='JavaScript'>
			  alert ('Sorry ! This Course Name OR Course Number Already Exist !');
      </script>";
...
$sql1 = mysqli_query($dbConn,"update courses set Mid_Hours='$Mid_Hours', Final_Hours='$Final_Hours', Department='$Department', Year='$Year', Semester='$Semester', Course_Number='$Course_Number', Course_Name='$Course_Name' where ID='$C_ID'");

echo "<script language='JavaScript'>
			  alert ('Course Information Has Been Updated !');
      </script>";
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                     ...
                     <form method="post" action="Edit_Course.php?C_ID=<?php echo $C_ID; ?>" class="form-horizontal" enctype="multipart/form-data">
...
<div class="form-group"><label class="col-sm-2 control-label">Course Number *</label>

                                    <div class="col-sm-10"><input type="text" style="width:40%" name="Course_Number" value="<?php echo $Course_Number; ?>" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
								 ...
								 <div class="form-group"><label class="col-sm-2 control-label">Course Name *</label>
                                    ...
                                    <div class="col-sm-10"><input type="text" style="width:40%" name="Course_Name" value="<?php echo $Course_Name; ?>" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
 ...
 <div class="form-group"><label class="col-sm-2 control-label">Mid Hours (In Minutes) *</label>

                                    <div class="col-sm-10"><input value="<?php echo $Mid_Hours; ?>" style="width:40%" type="text" name="Mid_Hours" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
 ...
 <div class="form-group"><label class="col-sm-2 control-label">Final Hours (In Minutes) *</label>

                                    <div class="col-sm-10"><input value="<?php echo $Final_Hours; ?>" style="width:40%" type="text" name="Final_Hours" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
