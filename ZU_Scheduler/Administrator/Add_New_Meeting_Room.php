...
$sql1 = mysqli_query($dbConn,"select * from meeting_rooms where Room_Name='$Room_Name'");
...
$insert = mysqli_query($dbConn,"insert into meeting_rooms (Department,Year,Semester,Room_Name) values ('$Department','$Year','$Semester','$Room_Name')");
...
echo "<script language='JavaScript'>
			  alert ('New Meeting Room Has Been Added Successfully !');
      </script>";
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                     ...
                     <form method="post" action="Add_New_Meeting_Room.php" class="form-horizontal" enctype="multipart/form-data">
