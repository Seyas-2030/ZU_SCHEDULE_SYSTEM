            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>View Sections List Information | <a href="Add_New_Section.php?Department=<?php echo $Department; ?>&Semester=<?php echo $Semester; ?>&Year=<?php echo $Year; ?>&Course_Name=<?php echo $Course_Name; ?>&C_ID=<?php echo $C_ID; ?>" class="btn btn-primary">Add New Section</a></h5>
                    ...
                    <tbody>
                    <?php
					$sql1 = mysqli_query($dbConn,"select * from sections where Course_ID='$C_ID' order by ID DESC");
					while ($row1 = mysqli_fetch_array($sql1)){
						...
						$S_ID = $row1['ID'];
											...
											$Instructor_ID = $row1['Instructor_ID'];
...
$sql7 = mysqli_query($dbConn,"select * from courses where ID='$C_ID'");
					$row7 = mysqli_fetch_array($sql7);
					$Course_Number = $row7['Course_Number'];
					$Course_Name = $row7['Course_Name'];
                    ...
                    <tr class="grade">
                          ...
                          <td><?php echo $Total_Students_Capacity; ?></td>
...
<a href="Edit_Section.php?S_ID=<?php echo $S_ID; ?>&C_ID=<?php echo $C_ID; ?>" style="width:52px" class="btn btn-primary btn-sm" role="button">Edit</a>

 <a href="JavaScript:if(confirm('Are You Sure To Delete This Section ?')==true)
{location.replace('Delete_Section.php?S_ID=<?php echo $S_ID; ?>&C_ID=<?php echo $C_ID; ?>')}" class="btn btn-primary btn-sm" role="button">Delete</a>
