...
$End_Date = mysqli_real_escape_string($dbConn,$_POST['End_Date']);
	...
	echo "<script language='JavaScript'>
document.location='Generate_Mid_Schedules_2.php?End_Date=".$End_Date."&Start_Date=".$Start_Date."&Department=".$Department."&Year=".$Year."&Semester=".$Semester."';
        </script>";
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                     ...
                     <form method="post" action="Generate_Mid_Schedules.php" class="form-horizontal" enctype="multipart/form-data">
