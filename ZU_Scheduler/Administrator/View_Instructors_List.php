            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>View Instructors List Information</h5>
                    ...
                    <tbody>
                    <?php
					$sql1 = mysqli_query($dbConn,"select * from instructors where Department='$Department' AND Year='$Year' AND Semester='$Semester' order by ID DESC");
                    ...
                    <tr class="grade">
                          ...
                          <td><?php echo $Instructor_Username; ?></td>
                          <td><?php echo $Instructor_Password; ?></td>
...
<a href="Edit_Instructor.php?I_ID=<?php echo $I_ID; ?>" style="width:52px" class="btn btn-primary btn-sm" role="button">Edit</a>

 <a href="JavaScript:if(confirm('Are You Sure To Delete This Instructor ?')==true)
{location.replace('Delete_Instructor.php?I_ID=<?php echo $I_ID; ?>')}" class="btn btn-primary btn-sm" role="button">Delete</a>
