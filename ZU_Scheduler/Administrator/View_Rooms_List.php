...
<li><a href="View_Mid_Schedules_List.php">View Mid Schedules List</a></li>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>View Rooms List Information</h5>
                    ...
                    <tbody>
                    <?php
					$sql1 = mysqli_query($dbConn,"select * from rooms where Department='$Department' AND Year='$Year' AND Semester='$Semester' order by ID DESC");
 ...
 <a href="Edit_Room.php?R_ID=<?php echo $R_ID; ?>" style="width:52px" class="btn btn-primary btn-sm" role="button">Edit</a>

 <a href="JavaScript:if(confirm('Are You Sure To Delete This Room ?')==true)
{location.replace('Delete_Room.php?R_ID=<?php echo $R_ID; ?>')}" class="btn btn-primary btn-sm" role="button">Delete</a>
