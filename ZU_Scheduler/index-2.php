    ...
    <div class="middle-box text-center loginscreen animated fadeInDown">
        <div>
		  ...
		  <h2>Select System Type</h2/>
		                  ...
		                  <a href="Examination_System.php?Year=<?php echo $Year; ?>&Semester=<?php echo $Semester; ?>&Department=<?php echo $Department; ?>" class="btn btn-primary block full-width m-b btn-lg">Examination System</a>
		                  <a href="Meeting_Rooms_System.php?Year=<?php echo $Year; ?>&Semester=<?php echo $Semester; ?>&Department=<?php echo $Department; ?>" class="btn btn-primary block full-width m-b btn-lg">Meeting Rooms System</a>

                               <a href="index.php?Year=<?php echo $Year; ?>&Semester=<?php echo $Semester; ?>&Department=<?php echo $Department; ?>" class="btn btn-danger block full-width m-b btn-lg">Back</a>
